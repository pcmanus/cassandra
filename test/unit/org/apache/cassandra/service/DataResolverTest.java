...
public class DataResolverTest
{
    ...
    private void resolveRangeTombstonesOnBoundary(long timestamp1, long timestamp2)
    {
        ...
        // Both streams are mostly complementary, so they will roughly get the ranges of the other stream. One subtly is
        // around the value "value" however, as it's included by both stream.
