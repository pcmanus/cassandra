...
public class Util
{
    ...
    public static ColumnDefinition colname(String keyspace, String cfname, ByteBuffer bbs)
    {
        CFMetaData cfm = Keyspace.open(keyspace).getColumnFamilyStore(cfname).metadata;
        return ColumnDefinition.compactValueDef(cfm, bbs, cfm.getDefaultValidator());
    }
