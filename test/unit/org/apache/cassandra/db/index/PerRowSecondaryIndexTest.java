...
public class PerRowSecondaryIndexTest
{
    ...
    public void testIndexInsertAndUpdate()
    {
        ...
        ColumnDefinition cdef = ColumnDefinition.compactValueDef(cfm, ByteBufferUtil.bytes("indexed"), cfm.getDefaultValidator());
        builder.add(cdef, ByteBufferUtil.bytes("foo"));
        builder.build().apply();
        ...
        builder.add(cdef, ByteBufferUtil.bytes("bar"));
        builder.build().apply();
    ...
    public void testRowDelete()
    {
        ...
        RowUpdateBuilder builder = new RowUpdateBuilder(cfm, FBUtilities.timestampMicros(), "k3");

        builder.deleteRow(FBUtilities.timestampMicros());
        builder.build().apply();
