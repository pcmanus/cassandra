...
public class NameSortTest
{
    ...
    private void testNameSort(int N) throws IOException
    {
        ...
        validateNameSort(cfs, N*8);
        keyspace.getColumnFamilyStore("Standard1").forceBlockingFlush();
        validateNameSort(cfs, N*8);
    }

    private void validateNameSort(ColumnFamilyStore cfs, int expectedCellCount) throws IOException
    {
        int foundCount = 0;
        ...
        assertEquals(expectedCellCount, foundCount);
    }
}
