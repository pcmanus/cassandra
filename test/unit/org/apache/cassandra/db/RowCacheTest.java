...
public class RowCacheTest extends SchemaLoader
{
    ...
    public void testRowCache() throws Exception
    {
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            cachedStore.getColumnFamily(key, Composites.NEG_INF, Composites.POS_INF, false, 1, System.currentTimeMillis());
            ...
            ColumnFamily cf = cachedStore.getColumnFamily(key, Composites.NEG_INF, Composites.POS_INF, false, 1, System.currentTimeMillis());
