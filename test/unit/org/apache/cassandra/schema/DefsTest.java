...
public class DefsTest
{
    ...
    public void dropCf() throws ConfigurationException
    {
        ...
        for (File file : cfs.directories.sstableLister().listFiles())
        {
    ...
    */
    ...
    public void testDropIndex() throws ConfigurationException
    {
        ...
        QueryProcessor.executeInternal(String.format("INSERT INTO %s.%s (key, cols, birthdate, notbirthdate) VALUES (?, ?, ?, ?)",
                                                     KEYSPACE6, TABLE1i),
                                       "key0", "col0", 1L, 1L);
