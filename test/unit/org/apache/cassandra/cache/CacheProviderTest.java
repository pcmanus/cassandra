...
public class CacheProviderTest
{
    ...
    private void assertDigests(IRowCacheEntry one, ArrayBackedCachedPartition two)
    {
        ...
        try
        {
            ...
            UnfilteredRowIterators.digest(((ArrayBackedCachedPartition) one).unfilteredIterator(), d1, MessagingService.current_version);
            UnfilteredRowIterators.digest(((ArrayBackedCachedPartition) two).unfilteredIterator(), d2, MessagingService.current_version);
