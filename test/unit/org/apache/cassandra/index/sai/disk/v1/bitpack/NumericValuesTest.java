...
public class NumericValuesTest extends SaiRandomizedTest
{
    ...
    private void testRepeatedNumericValues(boolean monotonic) throws Exception
    {
        ...
        IndexComponentInfo.Reader tokens = group.get(IndexComponent.TOKEN_VALUES);
    ...
    private void writeTokens(boolean monotonic, IndexDescriptor indexDescriptor, long[] array, LongFunction<Long> generator) throws Exception
    {
        ...
        try (MetadataWriter metadataWriter = new MetadataWriter(group);
             final NumericValuesWriter numericWriter = new NumericValuesWriter(group.addOrGet(IndexComponent.TOKEN_VALUES),
                                                                               metadataWriter,
                                                                               monotonic,
                                                                               blockSize))
        {
