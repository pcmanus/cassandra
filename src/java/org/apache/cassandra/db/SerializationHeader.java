...
public class SerializationHeader
{
    ...
    {
        return String.format("SerializationHeader[key=%s, cks=%s, columns=%s, stats=%s, typeMap=%s, baseTs=%d, baseDt=%s, baseTTL=%s, forSSTable=%b]",
                             keyType, clusteringTypes, columns, stats, typeMap, baseTimestamp, baseDeletionTime, baseTTL, forSSTable);
    }
    ...
    public static class Component extends MetadataComponent
    {
        ...
        public SerializationHeader toHeader(CFMetaData metadata)
        {
            ...
            return new SerializationHeader(keyType, clusteringTypes, builder.build(), stats, typeMap, true);
        }
    ...
    public static class Serializer implements IMetadataComponentSerializer<Component>
    {
        ...
        public SerializationHeader deserializeForMessaging(DataInput in, CFMetaData metadata, boolean hasStatic) throws IOException
        {
            ...
            return new SerializationHeader(keyType, clusteringTypes, new PartitionColumns(statics, regulars), stats, null, false);
        }
