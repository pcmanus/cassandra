...
public class Keyspace
{
    ...
    public void initCf(CFMetaData metadata, boolean loadSSTables)
    {
        ...
        if (cfs == null)
        {
            ...
            ColumnFamilyStore newCfs = ColumnFamilyStore.createColumnFamilyStore(this, metadata, loadSSTables);

            ColumnFamilyStore oldCfs = columnFamilyStores.putIfAbsent(metadata.cfId, newCfs);
