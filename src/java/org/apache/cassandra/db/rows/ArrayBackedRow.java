...
public class ArrayBackedRow extends AbstractRow
{
    ...
    {
        Map<ColumnIdentifier, CFMetaData.DroppedColumn> droppedColumns = metadata.getDroppedColumns();
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            {
                ColumnData newCd = dropped == null && !mayHaveShadowed
                                 ? cd
    ...
    public static class SortedBuilder extends AbstractBuilder
    {
        ...
        private int[] complexColumnCellsCount;
