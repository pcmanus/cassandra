...
public class UnfilteredRowIteratorSerializer
{
    ...
    public Header deserializeHeader(DataInputPlus in, int version, SerializationHelper.Flag flag, SerializationHeader header) throws IOException
    {
    ...
    public UnfilteredRowIterator deserialize(DataInputPlus in, int version, SerializationHelper.Flag flag, SerializationHeader header, Header partitionHeader) throws IOException
    {
        assert header != null;
    ...
    public UnfilteredRowIterator deserialize(DataInputPlus in, int version, SerializationHelper.Flag flag, SerializationHeader header) throws IOException
    {
