 ...
 *
 * A RowIterator is an AtomIterator to which any deletion information has been
 * filtered out. As such, all cell of all rows returned by this iterator are,
 * by definition, live.
 *
 * Note that as for AtomIterator, the rows returned must be in clustering order (or
