...
import static org.apache.cassandra.index.SecondaryIndexManager.IndexTransaction;
...
public class AtomicBTreePartition extends AbstractBTreePartition
{
     ...
     */
    public long[] addAllWithSizeDelta(final PartitionUpdate update, OpOrder.Group writeOp, IndexTransaction indexer)
    {
        ...
        try
        {
            ...
            while (true)
            {
                ...
                if (deletionInfo.hasRanges())
                    deletionInfo.rangeIterator(false).forEachRemaining(indexer::onRangeTombstone);
    ...
    private static final class RowUpdater implements UpdateFunction<Row, Row>
    {
        ...
        final IndexTransaction indexer;
        final int nowInSec;
        Holder ref;
        ...
        private RowUpdater(AtomicBTreePartition updating, MemtableAllocator allocator, OpOrder.Group writeOp, IndexTransaction indexer)
        {
