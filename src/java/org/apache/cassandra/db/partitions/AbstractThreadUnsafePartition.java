...
public abstract class AbstractThreadUnsafePartition implements Partition, Iterable<Row>
{
     ...
     *
     * Note: do not case the result to a {@code MutableDeletionInfo} to modify it! Use {@link addPartitionDeletion}/{@link addRangeTombstone}
     * instead. The reason being that some implementation wants to intercept any addition to the partition, including
     * deletion info addition (typically {@code PartitionUpdate} collects stats).
     *
