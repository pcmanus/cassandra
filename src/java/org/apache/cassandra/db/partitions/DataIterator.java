...
/**
 * An iterator over a number of row iterators.
 *
 * DataIterator is to RowIterator what PartitionIterator is to AtomIterator
 * though unlike PartitionIterator, it is not guaranteed that the RowIterator
 ...
 */
public interface DataIterator extends Iterator<RowIterator>, Closeable
{
}
