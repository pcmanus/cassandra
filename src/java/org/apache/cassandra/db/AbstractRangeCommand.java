...
public abstract class AbstractRangeCommand implements IReadCommand
{
    ...
    public AbstractRangeCommand(String keyspace, String columnFamily, AbstractBounds<RowPosition> keyRange, IDiskAtomFilter predicate, List<IndexExpression> rowFilter)
    {
