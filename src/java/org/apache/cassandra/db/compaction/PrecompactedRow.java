...
public class PrecompactedRow extends AbstractCompactedRow
{
    ...
    public long write(DataOutput out) throws IOException
    {
        ...
        long delSize = DeletionTime.serializer.serializedSize(compactedCf.deletionInfo().getTopLevelDeletion());
        long dataSize = buffer.getLength() + delSize + DBConstants.INT_SIZE;
