...
public abstract class ReadCommand implements ReadQuery
{
    ...
    protected SecondaryIndexManager.IndexAccessor getIndex(ColumnFamilyStore cfs, boolean includeInTrace)
    {
    ...
    public UnfilteredPartitionIterator executeLocally(ReadOrderGroup orderGroup)
    {
        ...
        SecondaryIndexManager.IndexAccessor index = getIndex(cfs, true);
        Index.Searcher searcher = index == null ? null : index.getSearcher();
