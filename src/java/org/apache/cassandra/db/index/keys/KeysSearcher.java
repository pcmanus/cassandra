...
public class KeysSearcher extends SecondaryIndexSearcher
{
    ...
    public ColumnFamilyStore.AbstractScanIterator getIndexedIterator(final ExtendedFilter filter)
    {
            ...
            protected Row computeNext()
            {
                ...
                while (true)
                {
                    ...
                    while (indexColumns.hasNext())
                    {
                        ...
                        ColumnFamily data = baseCfs.getColumnFamily(new QueryFilter(dk, baseCfs.name, filter.columnFilter(lastSeenKey)));
