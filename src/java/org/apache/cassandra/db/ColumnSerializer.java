...
public class ColumnSerializer implements IColumnSerializer
{
    ...
    public IColumn deserialize(DataInput dis, IColumnSerializer.Flag flag, int expireBefore, int version) throws IOException
    {
        ...
        return deserializeColumnBody(dis, name, b, flag, expireBefore, version);
    }

    IColumn deserializeColumnBody(DataInput dis, ByteBuffer name, int mask, IColumnSerializer.Flag flag, int expireBefore, int version) throws IOException
    {
