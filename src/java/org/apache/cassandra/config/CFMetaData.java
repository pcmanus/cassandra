...
public final class CFMetaData
{
    ...
    public ColumnNameBuilder getStaticColumnNameBuilder()
    {
        ...
        CompositeType.Builder builder = ((CompositeType)comparator).builder();
        builder.addStatic(ByteBufferUtil.EMPTY_BYTE_BUFFER);
        for (int i = 1; i < clusteringKeyColumns().size(); i++)
