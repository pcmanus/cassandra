...
public class QueryPagers
{
    ...
    {
        SliceFromReadCommand command = new SliceFromReadCommand(cfs.metadata.ksName, key, cfs.name, new IdentityQueryFilter());
    ...
    public static Iterator<Column> pageQuery(String keyspace,
                                             ...
                                             final int pageSize)
    {
        SliceFromReadCommand command = new SliceFromReadCommand(keyspace, key, columnFamily, filter);
