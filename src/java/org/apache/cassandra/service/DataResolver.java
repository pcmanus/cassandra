...
public class DataResolver extends ResponseResolver
{
    ...
    private class RepairMergeListener implements UnfilteredPartitionIterators.MergeListener
    {
        ...
        private class MergeListener implements UnfilteredRowIterators.MergeListener
        {
            ...
            // When merged has a currently open marker, it's time. null otherwise.
                ...
                for (int i = 0; i < versions.length; i++)
                {
                    ...
                    if (merged == null)
                    {
                        ...
                        if (markerToRepair[i] == null)
                        {
                            ...
                            // this source is that it had a range open with the same deletion than current and it's
                    ...
                    else
                    {
                        ...
                        {
                            // If we're closing the merged range and we had recorded this range must be sent to this peer, add
                            // it to the updates to send.
                            if (markerToRepair[i] != null)
