...
public final class TableMetadataRef
{
    ...
    private TableMetadataRef(TableMetadata metadata)
    {
     ...
     */
    public static TableMetadataRef to(TableMetadata metadata)
    {
    ...
    public void inPlaceUpdateIndexedTableMetadata(TableMetadata indexedTable)
    {
        assert get().isIndex();
        set(get().updateIndexTableMetadata(indexedTable.params));
    }
