...
public abstract class CollectionSerializer<T> implements TypeSerializer<T>
{
    ...
    protected static void skipValue(ByteBuffer input, int version)
    {
        int size = input.getInt();
     ...
     */
    protected ByteBuffer copyAsNewCollection(ByteBuffer input, int count, int startPos, int endPos, int version)
    {
