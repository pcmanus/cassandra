...
public class Version
{
    ...
    public static interface FileNameFormatter
    {
         ...
         */
        public String format(IndexComponent indexComponent, IndexContext indexContext, int generation);
    }
    ...
    public static Optional<ParsedFileName> tryParseFileName(String filename)
    {
        ...
        int startOfComponent = filename.lastIndexOf('-');
        if (startOfComponent == -1)
            return Optional.empty();

        String componentStr = filename.substring(startOfComponent + 1);
    ...
    public static class ParsedFileName
    {
        ...
        private ParsedFileName(Version version, IndexComponent component, @Nullable String indexName, int generation)
        {
            this.version = version;
    ...
    private static String aaFileNameFormat(IndexComponent indexComponent, IndexContext indexContext, int generation)
    {
    ...
    private static Optional<ParsedFileName> tryParseAAFileName(String componentStr)
    {
        ...
        IndexComponent indexComponent = IndexComponent.fromRepresentation(indexComponentStr);
        ...
        return Optional.of(new ParsedFileName(AA, indexComponent, indexName, generation));
    }
    ...
    private static String stargazerFileNameFormat(IndexComponent indexComponent, IndexContext indexContext, int generation, String version)
    {
        StringBuilder stringBuilder = new StringBuilder();
    ...
    private static Optional<ParsedFileName> tryParseStargazerFileName(String componentStr)
    {
        ...
        IndexComponent indexComponent = IndexComponent.fromRepresentation(splits[splits.length - 1]);
        ...
        return Optional.of(new ParsedFileName(version, indexComponent, indexName, generation));
    }
}
