 ...
 * <ul>
 *     <li>the sstable it is a group of components of (identified by the sstable {@link #descriptor()})</li>
 *     <li>the index it is the group of ({@link #context()}), which is {@code null} for the per-sstable group</li>
...
public interface ComponentGroup
{
     ...
     */
    default IndexComponent metadataComponent()
    {
        return isPerIndexGroup() ? IndexComponent.META : IndexComponent.GROUP_META;
    }

    /**
     * The specific component "kind" used as a completion marker for this group.
     */
    default IndexComponent completionMarkerComponent()
    {
        return isPerIndexGroup() ? IndexComponent.COLUMN_COMPLETION_MARKER : IndexComponent.GROUP_COMPLETION_MARKER;
    }
     ...
     */
    boolean has(IndexComponent component);
    ...
    /**
     * The set of component "kind" that a complete group of the version of this group is expected to have.
     */
    default Set<IndexComponent> expectedComponentsForVersion()
    {
    ...
    /**
     * Specialisation of {@link ComponentGroup} used when working with complete and active groups, and so mostly used
     * for reading components.
     */
    interface Reader extends ComponentGroup
    {
        IndexComponentInfo.Reader get(IndexComponent component);
        ...
        Collection<IndexComponentInfo.Reader> allComponents();

        default Set<Component> allAsCustomComponents()
        {
            return allComponents()
                   .stream()
                   .map(IndexComponentInfo::asCustomComponent)
         ...
         */
        boolean validateComponents(boolean validateChecksum);
         ...
         * <p>
         * Please note that this method is <b>already</b> called by {@link #validateComponents(boolean)} if the group
        ...
        /**
         * Returns a {@link Writer} view of this group, mostly for calling {@link Writer#forceDeleteAllComponents()} at
         * appropriate times.
         */
        Writer asWriter();
    }
    ...
    /**
     * Specialisation of {@link ComponentGroup} used when doing a new index build and thus writting a new group of
     * components.
     * <p>
     * This extends {@link Reader} because we sometimes read previously written components to write other ones in the group
     */
    interface Writer extends Reader
    {
         ...
         * been added.
         */
        IndexComponentInfo.Writer addOrGet(IndexComponent component);
         ...
         */
        default Writer addAllComponentsForVersion()
        {
