...
public class CompactionGraph implements Closeable, Accountable
{
    ...
    private final ComponentGroup.Writer componentsWriter;
    ...
    public CompactionGraph(ComponentGroup.Writer componentsWriter, ProductQuantization compressor, boolean unitVectors, long keyCount) throws IOException
    {
        this.componentsWriter = componentsWriter;
        this.context = componentsWriter.context();
        ...
        var dd = componentsWriter.descriptor();
        ...
        var indexFile = componentsWriter.addOrGet(IndexComponent.TERMS_DATA).file();
    ...
    public SegmentMetadata.ComponentMetadataMap flush(Set<Integer> deletedOrdinals) throws IOException
    {
        ...
        try (var postingsOutput = componentsWriter.addOrGet(IndexComponent.POSTING_LISTS).openOutput(true);
             var pqOutput = componentsWriter.addOrGet(IndexComponent.PQ).openOutput(true))
        {
