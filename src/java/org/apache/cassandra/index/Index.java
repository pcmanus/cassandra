...
public interface Index
{
    ...
    public interface Indexer
    {
         ...
         * it *does not* guarantee that the row does not exist in an SSTable.
         *
         ...
         *
         * @param oldRow the existing row from the base table's Memtable
         * @param newRow the replacement row inserted into the base Memtable
         */
        default void updateRow(Row oldRow, Row newRow){}
         ...
         * Row deletions via the normal write path are received as RangeTombstones
         * @param row
         */
         ...
         * This event always occurs after all others for the specific update.
         */
        default void finish(){}
    }
