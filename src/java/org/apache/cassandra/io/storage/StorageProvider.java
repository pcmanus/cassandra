...
public interface StorageProvider
{
     ...
     *   configured as appropriate.
     */
    FileHandle.Builder fileHandleBuilderFor(IndexComponentInfo.Reader component);
     ...
     * {@link #fileHandleBuilderFor(IndexComponentInfo.Reader)}.
     *
     * @param component index component for which to build the handler.
     * @return a new {@link FileHandle.Builder} for the provided SAI component with access mode and chunk cache
     *   configured as appropriate.
     */
    FileHandle.Builder flushTimeFileHandleBuilderFor(IndexComponentInfo.Reader component);
    ...
    class DefaultProvider implements StorageProvider
    {
        ...
        @Override
        @SuppressWarnings("resource")
        public FileHandle.Builder fileHandleBuilderFor(IndexComponentInfo.Reader component)
        {
            File file = component.file();
            if (logger.isTraceEnabled())
            {
                logger.trace(component.group().logMessage("Opening {} file handle for {} ({})"),
        ...
        @Override
        public FileHandle.Builder flushTimeFileHandleBuilderFor(IndexComponentInfo.Reader component)
        {
