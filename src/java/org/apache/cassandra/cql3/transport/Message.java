...
public abstract class Message
{
    ...
    {
        public M decode(ChannelBuffer body);
        public ChannelBuffer encode(M msg);
    }
    ...
    public static class Dispatcher extends SimpleChannelUpstreamHandler
    {
        ...
        throws Exception
        {
            ...
            if (msg == null)
                msg = "Internal error, see server log for more details";

            ctx.getChannel().write(new ErrorMessage(msg));
        }
    }
}
