...
public class ExecuteMessage extends Message.Request
{
    public static final Message.Codec<ExecuteMessage> codec = new Message.Codec<ExecuteMessage>()
    {
        public ExecuteMessage decode(ChannelBuffer body)
        {
            ...
            Map<QueryMessage.Option, Object> options = QueryMessage.optionCodec.decode(body);
            return new ExecuteMessage(id, values, options);
        }
        ...
        public ChannelBuffer encode(ExecuteMessage msg)
        {
            ...
            builder.add(QueryMessage.optionCodec.encode(msg.options));
    ...
    public final Map<QueryMessage.Option, Object> options;

    public ExecuteMessage(int statementId, List<ByteBuffer> values, Map<QueryMessage.Option, Object> options)
    {
    ...
    {
        return "EXECUTE " + statementId + " with " + values.size() + " values (opts=" + options + ")";
    }
}
