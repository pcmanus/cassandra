...
public class Client extends SimpleClient
{
    ...
    private Message.Request parseLine(String line)
    {
        ...
        else if (msgType.equals("QUERY"))
        {
            ...
            return new QueryMessage(query, Collections.<QueryMessage.Option, Object>emptyMap());
        }
        ...
        else if (msgType.equals("EXECUTE"))
        {
            try
            {
                ...
                return new ExecuteMessage(id, values, Collections.<QueryMessage.Option, Object>emptyMap());
            }
            catch (Exception e)
            {
                return null;
