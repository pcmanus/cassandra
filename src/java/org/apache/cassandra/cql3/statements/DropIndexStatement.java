...
public class DropIndexStatement extends SchemaAlteringStatement
{
    ...
    public String columnFamily()
    {
        ...
        return metadata == null ? null : metadata.table;
    }
    ...
    public void checkAccess(ClientState state) throws UnauthorizedException, InvalidRequestException
    {
        ...
        state.hasColumnFamilyAccess(metadata.keyspace, metadata.table, Permission.ALTER);
    }
    ...
    public Event.SchemaChange announceMigration(boolean isLocalOnly) throws InvalidRequestException, ConfigurationException
    {
        ...
        return new Event.SchemaChange(Event.SchemaChange.Change.UPDATED, Event.SchemaChange.Target.TABLE, current.keyspace, current.table);
    }
