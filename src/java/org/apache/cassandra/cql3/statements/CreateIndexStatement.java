...
public class CreateIndexStatement extends SchemaAlteringStatement
{
    ...
    public void validate(ClientState state) throws RequestValidationException
    {
        ...
        // It would be possible to support 2ndary index on static columns and maybe we should, but that means a query like:
        ...
        // fair potential for foot-shooting, so I prefer leaving that to a follow up ticket once we have identified case where
