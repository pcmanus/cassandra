    ...
    public Prepared prepare()
    {
        ...
        if (ival != null)
        {
            ...
            if (initcond != null)
            {
                ...
                {
                    String details = e.getMessage() == null ? "" : String.format(" (%)", e.getMessage());
                    throw new InvalidRequestException(String.format("Invalid value for INITCOND of type %s%s", stateType.asCQL3Type(), details));
                }
            }
