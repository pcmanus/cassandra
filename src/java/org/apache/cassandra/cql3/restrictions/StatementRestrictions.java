...
public final class StatementRestrictions
{
                                 ...
                                 boolean forView)
    {
        ...
        {
            cfs = Keyspace.open(table.keyspace).getColumnFamilyStore(table.table);
                                                      ...
                                                      boolean allowFiltering)
    {
        ...
        if (!type.allowClusteringColumnSlices()
               && (!table.isCompactTable() || (table.isCompactTable() && !hasClusteringColumnsRestriction())))
        {
                                               ...
                                               SecondaryIndexManager indexManager)
    {
        ...
        if (cfName.getColumnFamily() != null && !cfName.getColumnFamily().equals(table.table))
            throw IndexRestrictions.invalidIndex(expression.targetIndex, table);
