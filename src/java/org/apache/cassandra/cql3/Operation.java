...
public abstract class Operation
{
     ...
     * @param update the row update to which to add the updates generated by this operation.
     * @param params parameters of the update.
     */
    public abstract void execute(ByteBuffer rowKey, RowUpdate update, UpdateParameters params) throws InvalidRequestException;
