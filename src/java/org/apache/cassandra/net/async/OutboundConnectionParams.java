...
class OutboundConnectionParams
{
    ...
    final int channelSendBufferSize;
    final boolean maybeCoalesce;
    final boolean compress;
    final AtomicLong droppedMessageCount;
    final AtomicLong completedMessageCount;

    OutboundConnectionParams(InetSocketAddress localAddr, InetSocketAddress remoteAddr, int protocolVersion, int channelSendBufferSize,
    ...
    {
        return new OutboundConnectionParams(localAddr, remoteAddr, protocolVersion, channelSendBufferSize, callback,
