            ...
            new Gauge<Map<String, Map<String, Integer>>>()
        {
            ...
            public Map<String, Map<String, Integer>> getValue() 
            {
                ...
                for (CompactionInfo.Holder compaction : compactions)
                {
                    ...
                    if (tableNameToCountMap.containsKey(metaData.table))
                    {
                        tableNameToCountMap.put(metaData.table,
                                                tableNameToCountMap.get(metaData.table) + 1);
                    }
                    else
                    {
                        tableNameToCountMap.put(metaData.table, 1);
                    }
                }
                return resultMap;
            }
