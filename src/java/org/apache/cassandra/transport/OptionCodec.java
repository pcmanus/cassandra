...
public class OptionCodec<T extends Enum<T> & OptionCodec.Codecable<T>>
{
    public interface Codecable<T extends Enum<T>>
    {
        ...
        public Object readValue(ChannelBuffer cb, int version);
        public void writeValue(Object value, ChannelBuffer cb, int version);
    ...
    public Map<T, Object> decode(ChannelBuffer body, int version)
    {
    ...
    public ChannelBuffer encode(Map<T, Object> options, int version)
    {
        int optLength = 2;
    ...
    public Pair<T, Object> decodeOne(ChannelBuffer body, int version)
    {
        T opt = fromId(body.readUnsignedShort());
        Object value = opt.readValue(body, version);
    ...
    public void writeOne(Pair<T, Object> option, ChannelBuffer dest, int version)
    {
        T opt = option.left;
